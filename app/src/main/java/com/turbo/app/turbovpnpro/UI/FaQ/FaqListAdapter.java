...
public class FaqListAdapter extends BaseExpandableListAdapter {
    ...
    // constructor
    public FaqListAdapter(Context context, List<String> expandableListTitle,
    ...
    public View getChildView(int lstPosn, final int expanded_ListPosition,
        ...
        if (convertView == null) {
            ...
            convertView = layoutInflater.inflate(R.layout.faq_detail, null);
        }
        TextView expandedListTextView = (TextView) convertView.findViewById(R.id.faq_detail);
    ...
    public View getGroupView(int listPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        TextView listTitleTextView = (TextView) convertView.findViewById(R.id.title_txt);
